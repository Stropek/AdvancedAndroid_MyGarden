...
public class PlantWateringService extends IntentService {
    ...
    private void handleActionUpdatePlantWidgets() {
        ...
        Cursor cursor = getContentResolver().query(plantUri, null, null, null, PlantContract.PlantEntry.COLUMN_LAST_WATERED_TIME);

        int imgResId = R.drawable.grass;
        if (cursor != null && cursor.getCount() > 0) {
            ...
            cursor.close();
            imgResId = PlantUtils.getPlantImageRes(this, now - createdAt, now - wateredAt, plantType);
        }

        AppWidgetManager widgetManager = AppWidgetManager.getInstance(this);
        int[] appWidgetsIds = widgetManager.getAppWidgetIds(new ComponentName(this, PlantWidgetProvider.class));
        PlantWidgetProvider.updatePlantWidgets(this, widgetManager, imgResId, appWidgetsIds);
    }
}
